...
class StandartScreenLarge extends StatefulWidget {
  const StandartScreenLarge({super.key});

  @override
  State<StandartScreenLarge> createState() => _StandartScreenLargeState();
}

class _StandartScreenLargeState extends State<StandartScreenLarge> {
