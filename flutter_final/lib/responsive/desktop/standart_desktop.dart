...
class StandartScreenDesktop extends StatefulWidget {
  const StandartScreenDesktop({super.key});

  @override
  State<StandartScreenDesktop> createState() => _StandartScreenDesktopState();
}

class _StandartScreenDesktopState extends State<StandartScreenDesktop> {
