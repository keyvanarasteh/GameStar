...
class StandartScreenMobile extends StatefulWidget {
  const StandartScreenMobile({super.key});

  @override
  State<StandartScreenMobile> createState() => _StandartScreenMobileState();
}

class _StandartScreenMobileState extends State<StandartScreenMobile> {
